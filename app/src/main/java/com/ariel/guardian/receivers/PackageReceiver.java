    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equals("android.intent.action.PACKAGE_ADDED")) {
            ...
            if (deviceApp != null) {
                ...
                long id = mArielPubNub.createApplicationMessage(deviceApp, ArielConstants.ACTION.APPLICATION_ADDED, false, true);
                ...
                long id = mArielPubNub.createApplicationMessage(deviceApplication, ArielConstants.ACTION.APPLICATION_ADDED, false, true);
                context.startService(SyncIntentService.getSyncIntent(id));
            }
            ...
            if(deviceApp!=null) {
                ...
                mArielDatabase.createOrUpdateApplication(deviceApp);
                long id = mArielPubNub.createApplicationMessage(deviceApp, ArielConstants.ACTION.APPLICATION_REMOVED, false, true);
                context.startService(SyncIntentService.getSyncIntent(id));
            }
